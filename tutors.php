                ...
                <div class="row">
                    ...
                    <div class="col-9 c_course-left-wrap">
                        <div class="c_course-left-nav-wrap">
                            <h5 class="fw-bold">ACTIVE TUTORS</h5>
                            <nav class="card p-2 mb-3">
                                <div class="row">
                                    <div class="col-10">
                                        <div class="c_course-left-nav-search-wrap">
                                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter tutor name or course">
